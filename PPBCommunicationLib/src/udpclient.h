...
public:
    ...
    virtual bool bind(quint16 port = 101);
    virtual void unbind();
    virtual bool isBound() const;

    virtual qint64 sendTo(const QByteArray& data, const QString& address, quint16 port);
    virtual qint64 sendBroadcast(const QByteArray& data, quint16 port);

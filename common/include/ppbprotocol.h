...
enum class TechCommand : uint8_t {
    ...
    PROGRAMM = 0x05,    // обновить исп файл ПО - зайти в бутлодер
    CLEAN = 0x0A,       // очистить временный файл ПО
    UPDATE = 0x7e,      // обновить прошивку и выйти из бутлодера
    ...
    Factory_Number = 0x1F, // выдать заводской номер устройства

    IS_YOU = 0x20  // ПОХУЮ! команда-обманка для движка
};
